...
func (x *ValidationFlags) Deref() {
	...
	hxf5ebb88 := (*sliceHeader)(unsafe.Pointer(&x.PDisabledValidationChecks))
	hxf5ebb88.Data = uintptr(unsafe.Pointer(x.refffe080ad.pDisabledValidationChecks))
...
func (x *ObjectTableCreateInfoNVX) Deref() {
	...
	hxff20e84 := (*sliceHeader)(unsafe.Pointer(&x.PObjectEntryTypes))
	hxff20e84.Data = uintptr(unsafe.Pointer(x.refb4a6c9e1.pObjectEntryTypes))
	hxff20e84.Cap = 0x7fffffff
	// hxff20e84.Len = ?

	hxfa26a4d := (*sliceHeader)(unsafe.Pointer(&x.PObjectEntryCounts))
	hxfa26a4d.Data = uintptr(unsafe.Pointer(x.refb4a6c9e1.pObjectEntryCounts))
	hxfa26a4d.Cap = 0x7fffffff
	// hxfa26a4d.Len = ?

	hxfe48098 := (*sliceHeader)(unsafe.Pointer(&x.PObjectEntryUsageFlags))
	hxfe48098.Data = uintptr(unsafe.Pointer(x.refb4a6c9e1.pObjectEntryUsageFlags))
