...
// allocSurfaceCapabilities2Memory allocates memory for type C.VkSurfaceCapabilities2EXT in C.
// The caller is responsible for freeing the this memory via C.free.
...
const sizeOfSurfaceCapabilities2Value = unsafe.Sizeof([1]C.VkSurfaceCapabilities2EXT{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *SurfaceCapabilities2) Ref() *C.VkSurfaceCapabilities2EXT {
	if x == nil {
		return nil
	}
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *SurfaceCapabilities2) PassRef() (*C.VkSurfaceCapabilities2EXT, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref43790d2b != nil {
		return x.ref43790d2b, nil
	}
	mem43790d2b := allocSurfaceCapabilities2Memory(1)
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x SurfaceCapabilities2) PassValue() (C.VkSurfaceCapabilities2EXT, *cgoAllocMap) {
