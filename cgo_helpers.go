...
// PassRef returns a reference.
func (x PFNVoidFunction) PassRef() (ref *C.PFN_vkVoidFunction, allocs *cgoAllocMap) {
	if pFNVoidFunction4CD0423BFunc == nil {
		pFNVoidFunction4CD0423BFunc = x
	}
	return (*C.PFN_vkVoidFunction)(C.PFN_vkVoidFunction_4cd0423b), nil
}

// PassValue returns a value.
func (x PFNVoidFunction) PassValue() (ref C.PFN_vkVoidFunction, allocs *cgoAllocMap) {
	if pFNVoidFunction4CD0423BFunc == nil {
		pFNVoidFunction4CD0423BFunc = x
	}
	return (C.PFN_vkVoidFunction)(C.PFN_vkVoidFunction_4cd0423b), nil
...
//export pFNVoidFunction4CD0423B
func pFNVoidFunction4CD0423B() {
	if pFNVoidFunction4CD0423BFunc != nil {
		pFNVoidFunction4CD0423BFunc()
	}
	panic("callback func has not been set (race?)")
}

var pFNVoidFunction4CD0423BFunc PFNVoidFunction
...
func packSAndroidSurfaceCreateInfoKHR(v []AndroidSurfaceCreateInfoKHR, ptr0 *C.VkAndroidSurfaceCreateInfoKHR) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.VkAndroidSurfaceCreateInfoKHR)(unsafe.Pointer(ptr0)))[i0]
...
func packSDebugMarkerObjectTagInfoEXT(v []DebugMarkerObjectTagInfoEXT, ptr0 *C.VkDebugMarkerObjectTagInfoEXT) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.VkDebugMarkerObjectTagInfoEXT)(unsafe.Pointer(ptr0)))[i0]
...
func packSDebugMarkerObjectNameInfoEXT(v []DebugMarkerObjectNameInfoEXT, ptr0 *C.VkDebugMarkerObjectNameInfoEXT) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.VkDebugMarkerObjectNameInfoEXT)(unsafe.Pointer(ptr0)))[i0]
...
func packSDebugMarkerMarkerInfoEXT(v []DebugMarkerMarkerInfoEXT, ptr0 *C.VkDebugMarkerMarkerInfoEXT) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m]C.VkDebugMarkerMarkerInfoEXT)(unsafe.Pointer(ptr0)))[i0]
