...
// NewDedicatedAllocationImageCreateInfoNVRef initialises a new struct holding the reference to the originaitng C struct.
...
// NewDedicatedAllocationBufferCreateInfoNVRef initialises a new struct holding the reference to the originaitng C struct.
...
// NewDedicatedAllocationMemoryAllocateInfoNVRef initialises a new struct holding the reference to the originaitng C struct.
