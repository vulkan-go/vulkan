...
const (
	// UsePlatformAndroidKhr as defined in vulkan/<predefine>:13
	UsePlatformAndroidKhr = 1
	...
	// ColorspaceSrgbNonlinearKhr as defined in vulkan/vulkan.h:3175
	...
	// StructureTypeDebugReportCreateInfoExt as defined in vulkan/vulkan.h:3720
...
const (
	ColorSpaceSrgbNonlinearKhr ColorSpace = 0
	ColorSpaceBeginRangeKhr    ColorSpace = 0
	ColorSpaceEndRangeKhr      ColorSpace = 0
	ColorSpaceRangeSizeKhr     ColorSpace = 1
	ColorSpaceMaxEnumKhr       ColorSpace = 2147483647
)
...
const (
	PresentModeImmediateKhr   PresentMode = 0
	PresentModeMailboxKhr     PresentMode = 1
	PresentModeFifoKhr        PresentMode = 2
	PresentModeFifoRelaxedKhr PresentMode = 3
	PresentModeBeginRangeKhr  PresentMode = 0
	PresentModeEndRangeKhr    PresentMode = 3
	PresentModeRangeSizeKhr   PresentMode = 4
	PresentModeMaxEnumKhr     PresentMode = 2147483647
)
...
const (
	SurfaceTransformIdentityBitKhr                  SurfaceTransformFlagBits = 1
	SurfaceTransformRotate90BitKhr                  SurfaceTransformFlagBits = 2
	SurfaceTransformRotate180BitKhr                 SurfaceTransformFlagBits = 4
	SurfaceTransformRotate270BitKhr                 SurfaceTransformFlagBits = 8
	SurfaceTransformHorizontalMirrorBitKhr          SurfaceTransformFlagBits = 16
	SurfaceTransformHorizontalMirrorRotate90BitKhr  SurfaceTransformFlagBits = 32
	SurfaceTransformHorizontalMirrorRotate180BitKhr SurfaceTransformFlagBits = 64
	SurfaceTransformHorizontalMirrorRotate270BitKhr SurfaceTransformFlagBits = 128
	SurfaceTransformInheritBitKhr                   SurfaceTransformFlagBits = 256
	SurfaceTransformFlagBitsMaxEnumKhr              SurfaceTransformFlagBits = 2147483647
)
...
const (
	CompositeAlphaOpaqueBitKhr         CompositeAlphaFlagBits = 1
	CompositeAlphaPreMultipliedBitKhr  CompositeAlphaFlagBits = 2
	CompositeAlphaPostMultipliedBitKhr CompositeAlphaFlagBits = 4
	CompositeAlphaInheritBitKhr        CompositeAlphaFlagBits = 8
	CompositeAlphaFlagBitsMaxEnumKhr   CompositeAlphaFlagBits = 2147483647
)
...
const (
	DisplayPlaneAlphaOpaqueBitKhr                DisplayPlaneAlphaFlagBits = 1
	DisplayPlaneAlphaGlobalBitKhr                DisplayPlaneAlphaFlagBits = 2
	DisplayPlaneAlphaPerPixelBitKhr              DisplayPlaneAlphaFlagBits = 4
	DisplayPlaneAlphaPerPixelPremultipliedBitKhr DisplayPlaneAlphaFlagBits = 8
	DisplayPlaneAlphaFlagBitsMaxEnumKhr          DisplayPlaneAlphaFlagBits = 2147483647
)
...
const (
	DebugReportObjectTypeUnknownExt             DebugReportObjectType = 0
	DebugReportObjectTypeInstanceExt            DebugReportObjectType = 1
	DebugReportObjectTypePhysicalDeviceExt      DebugReportObjectType = 2
	DebugReportObjectTypeDeviceExt              DebugReportObjectType = 3
	DebugReportObjectTypeQueueExt               DebugReportObjectType = 4
	DebugReportObjectTypeSemaphoreExt           DebugReportObjectType = 5
	DebugReportObjectTypeCommandBufferExt       DebugReportObjectType = 6
	DebugReportObjectTypeFenceExt               DebugReportObjectType = 7
	DebugReportObjectTypeDeviceMemoryExt        DebugReportObjectType = 8
	DebugReportObjectTypeBufferExt              DebugReportObjectType = 9
	DebugReportObjectTypeImageExt               DebugReportObjectType = 10
	DebugReportObjectTypeEventExt               DebugReportObjectType = 11
	DebugReportObjectTypeQueryPoolExt           DebugReportObjectType = 12
	DebugReportObjectTypeBufferViewExt          DebugReportObjectType = 13
	DebugReportObjectTypeImageViewExt           DebugReportObjectType = 14
	DebugReportObjectTypeShaderModuleExt        DebugReportObjectType = 15
	DebugReportObjectTypePipelineCacheExt       DebugReportObjectType = 16
	DebugReportObjectTypePipelineLayoutExt      DebugReportObjectType = 17
	DebugReportObjectTypeRenderPassExt          DebugReportObjectType = 18
	DebugReportObjectTypePipelineExt            DebugReportObjectType = 19
	DebugReportObjectTypeDescriptorSetLayoutExt DebugReportObjectType = 20
	DebugReportObjectTypeSamplerExt             DebugReportObjectType = 21
	DebugReportObjectTypeDescriptorPoolExt      DebugReportObjectType = 22
	DebugReportObjectTypeDescriptorSetExt       DebugReportObjectType = 23
	DebugReportObjectTypeFramebufferExt         DebugReportObjectType = 24
	DebugReportObjectTypeCommandPoolExt         DebugReportObjectType = 25
	DebugReportObjectTypeSurfaceKhrExt          DebugReportObjectType = 26
	DebugReportObjectTypeSwapchainKhrExt        DebugReportObjectType = 27
	DebugReportObjectTypeDebugReportExt         DebugReportObjectType = 28
	DebugReportObjectTypeBeginRangeExt          DebugReportObjectType = 0
	DebugReportObjectTypeEndRangeExt            DebugReportObjectType = 28
	DebugReportObjectTypeRangeSizeExt           DebugReportObjectType = 29
	DebugReportObjectTypeMaxEnumExt             DebugReportObjectType = 2147483647
)
...
const (
	DebugReportErrorNoneExt        DebugReportError = 0
	DebugReportErrorCallbackRefExt DebugReportError = 1
	DebugReportErrorBeginRangeExt  DebugReportError = 0
	DebugReportErrorEndRangeExt    DebugReportError = 1
	DebugReportErrorRangeSizeExt   DebugReportError = 2
	DebugReportErrorMaxEnumExt     DebugReportError = 2147483647
)
...
const (
	DebugReportInformationBitExt        DebugReportFlagBits = 1
	DebugReportWarningBitExt            DebugReportFlagBits = 2
	DebugReportPerformanceWarningBitExt DebugReportFlagBits = 4
	DebugReportErrorBitExt              DebugReportFlagBits = 8
	DebugReportDebugBitExt              DebugReportFlagBits = 16
	DebugReportFlagBitsMaxEnumExt       DebugReportFlagBits = 2147483647
)
