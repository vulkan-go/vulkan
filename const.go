...
const (
	...
	// KhrSurface as defined in vulkan/vulkan.h:3182
	KhrSurface = 1
	// KhrSurfaceSpecVersion as defined in vulkan/vulkan.h:3185
	KhrSurfaceSpecVersion = 25
	// KhrSurfaceExtensionName as defined in vulkan/vulkan.h:3186
	...
	// KhrSwapchain as defined in vulkan/vulkan.h:3288
	KhrSwapchain = 1
	// KhrSwapchainSpecVersion as defined in vulkan/vulkan.h:3291
	KhrSwapchainSpecVersion = 68
	// KhrSwapchainExtensionName as defined in vulkan/vulkan.h:3292
	KhrSwapchainExtensionName = "VK_KHR_swapchain"
	// KhrDisplay as defined in vulkan/vulkan.h:3366
	KhrDisplay = 1
	// KhrDisplaySpecVersion as defined in vulkan/vulkan.h:3370
	KhrDisplaySpecVersion = 21
	// KhrDisplayExtensionName as defined in vulkan/vulkan.h:3371
	KhrDisplayExtensionName = "VK_KHR_display"
	// KhrDisplaySwapchain as defined in vulkan/vulkan.h:3494
	KhrDisplaySwapchain = 1
	// KhrDisplaySwapchainSpecVersion as defined in vulkan/vulkan.h:3495
	KhrDisplaySwapchainSpecVersion = 9
	// KhrDisplaySwapchainExtensionName as defined in vulkan/vulkan.h:3496
	KhrDisplaySwapchainExtensionName = "VK_KHR_display_swapchain"
	// KhrAndroidSurface as defined in vulkan/vulkan.h:3661
	KhrAndroidSurface = 1
	// KhrAndroidSurfaceSpecVersion as defined in vulkan/vulkan.h:3664
	KhrAndroidSurfaceSpecVersion = 6
	// KhrAndroidSurfaceExtensionName as defined in vulkan/vulkan.h:3665
	KhrAndroidSurfaceExtensionName = "VK_KHR_android_surface"
	// KhrSamplerMirrorClampToEdge as defined in vulkan/vulkan.h:3722
	KhrSamplerMirrorClampToEdge = 1
	// KhrSamplerMirrorClampToEdgeSpecVersion as defined in vulkan/vulkan.h:3723
	KhrSamplerMirrorClampToEdgeSpecVersion = 1
	// KhrSamplerMirrorClampToEdgeExtensionName as defined in vulkan/vulkan.h:3724
	KhrSamplerMirrorClampToEdgeExtensionName = "VK_KHR_sampler_mirror_clamp_to_edge"
	// ExtDebugReport as defined in vulkan/vulkan.h:3727
	ExtDebugReport = 1
	// ExtDebugReportSpecVersion as defined in vulkan/vulkan.h:3730
	ExtDebugReportSpecVersion = 3
	// ExtDebugReportExtensionName as defined in vulkan/vulkan.h:3731
	ExtDebugReportExtensionName = "VK_EXT_debug_report"
	// StructureTypeDebugReportCreateInfo as defined in vulkan/vulkan.h:3732
	StructureTypeDebugReportCreateInfo = 0
	// NvGlslShader as defined in vulkan/vulkan.h:3838
	NvGlslShader = 1
	// NvGlslShaderSpecVersion as defined in vulkan/vulkan.h:3839
	NvGlslShaderSpecVersion = 1
	// NvGlslShaderExtensionName as defined in vulkan/vulkan.h:3840
	NvGlslShaderExtensionName = "VK_NV_glsl_shader"
	// ImgFilterCubic as defined in vulkan/vulkan.h:3843
	ImgFilterCubic = 1
	// ImgFilterCubicSpecVersion as defined in vulkan/vulkan.h:3844
	ImgFilterCubicSpecVersion = 1
	// ImgFilterCubicExtensionName as defined in vulkan/vulkan.h:3845
	ImgFilterCubicExtensionName = "VK_IMG_filter_cubic"
	// AmdRasterizationOrder as defined in vulkan/vulkan.h:3848
	AmdRasterizationOrder = 1
	// AmdRasterizationOrderSpecVersion as defined in vulkan/vulkan.h:3849
	AmdRasterizationOrderSpecVersion = 1
	// AmdRasterizationOrderExtensionName as defined in vulkan/vulkan.h:3850
	AmdRasterizationOrderExtensionName = "VK_AMD_rasterization_order"
	// AmdShaderTrinaryMinmax as defined in vulkan/vulkan.h:3870
	AmdShaderTrinaryMinmax = 1
	// AmdShaderTrinaryMinmaxSpecVersion as defined in vulkan/vulkan.h:3871
	AmdShaderTrinaryMinmaxSpecVersion = 1
	// AmdShaderTrinaryMinmaxExtensionName as defined in vulkan/vulkan.h:3872
	AmdShaderTrinaryMinmaxExtensionName = "VK_AMD_shader_trinary_minmax"
	// AmdShaderExplicitVertexParameter as defined in vulkan/vulkan.h:3875
	AmdShaderExplicitVertexParameter = 1
	// AmdShaderExplicitVertexParameterSpecVersion as defined in vulkan/vulkan.h:3876
	AmdShaderExplicitVertexParameterSpecVersion = 1
	// AmdShaderExplicitVertexParameterExtensionName as defined in vulkan/vulkan.h:3877
	AmdShaderExplicitVertexParameterExtensionName = "VK_AMD_shader_explicit_vertex_parameter"
	// ExtDebugMarker as defined in vulkan/vulkan.h:3880
	ExtDebugMarker = 1
	// ExtDebugMarkerSpecVersion as defined in vulkan/vulkan.h:3881
	ExtDebugMarkerSpecVersion = 3
	// ExtDebugMarkerExtensionName as defined in vulkan/vulkan.h:3882
	ExtDebugMarkerExtensionName = "VK_EXT_debug_marker"
	// AmdGcnShader as defined in vulkan/vulkan.h:3937
	AmdGcnShader = 1
	// AmdGcnShaderSpecVersion as defined in vulkan/vulkan.h:3938
	AmdGcnShaderSpecVersion = 1
	// AmdGcnShaderExtensionName as defined in vulkan/vulkan.h:3939
	AmdGcnShaderExtensionName = "VK_AMD_gcn_shader"
	// NvDedicatedAllocation as defined in vulkan/vulkan.h:3942
	NvDedicatedAllocation = 1
	// NvDedicatedAllocationSpecVersion as defined in vulkan/vulkan.h:3943
	NvDedicatedAllocationSpecVersion = 1
	// NvDedicatedAllocationExtensionName as defined in vulkan/vulkan.h:3944
	NvDedicatedAllocationExtensionName = "VK_NV_dedicated_allocation"
	// ImgFormatPvrtc as defined in vulkan/vulkan.h:3967
	ImgFormatPvrtc = 1
	// ImgFormatPvrtcSpecVersion as defined in vulkan/vulkan.h:3968
	ImgFormatPvrtcSpecVersion = 1
	// ImgFormatPvrtcExtensionName as defined in vulkan/vulkan.h:3969
