...
/*
#cgo LDFLAGS: -F/Users/oreilly/dev/ios/MoltenVK/MoltenVK -framework Foundation -framework Metal -framework QuartzCore -framework IOSurface -framework MoltenVK -lc++
...
type MVKDeviceConfiguration struct {
	...
	ref1c21f673                  *C.MVKConfiguration
...
// allocMVKDeviceConfigurationMemory allocates memory for type C.MVKConfiguration in C.
// The caller is responsible for freeing the this memory via C.free.
...
const sizeOfMVKDeviceConfigurationValue = unsafe.Sizeof([1]C.MVKConfiguration{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *MVKDeviceConfiguration) Ref() *C.MVKConfiguration {
	if x == nil {
		return nil
	}
...
func NewMVKDeviceConfigurationRef(ref unsafe.Pointer) *MVKDeviceConfiguration {
	...
	obj.ref1c21f673 = (*C.MVKConfiguration)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *MVKDeviceConfiguration) PassRef() (*C.MVKConfiguration, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	...
	ref1c21f673 := (*C.MVKConfiguration)(mem1c21f673)
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x MVKDeviceConfiguration) PassValue() (C.MVKConfiguration, *cgoAllocMap) {
